<div class="ke-panel-content">
	<script type="text/javascript">
		function onEncounterEdit() {
			ui.navigate('wellness', 'editForm', { appId: '${ currentApp.id }', encounterId: ${ encounter.id }, returnUrl: '${ currentUrl }' });
		}
		function onEncounterDelete(encounterId) {
			if (confirm('Are you sure you want to delete this encounter?')) {
				ui.getFragmentActionAsJson('wellness', 'form/formUtils', 'deleteEncounter', { appId: '${ currentApp.id }', encounterId: encounterId }, function() {
					ui.reloadPage();
				});
			}
		}
