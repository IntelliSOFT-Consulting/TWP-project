<% if (encounter) { %>
<button type="button" class="ke-compact" onclick="ui.navigate('${ ui.pageLink("wellness", "editForm", [ encounterId: encounter.id, appId: currentApp.id, returnUrl: ui.thisUrl() ]) }')">
