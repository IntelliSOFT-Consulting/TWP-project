...
package org.openmrs.module.wellness.fragment.controller.account;
	...
	public class EditUserDetailsForm extends ValidatingCommandObject {
		...
		public void validate(Object target, Errors errors) {
			...
			if (StringUtils.isEmpty(command.getUsername())) {
				errors.rejectValue("username", "wellness.error.required");
			} else {
				if ((original == null || !command.getUsername().equals(original.getUsername()))
					...
					errors.rejectValue("username", "wellness.error.username.taken");
				}
			}

			if (StringUtils.isEmpty(command.getPassword())) {
				errors.rejectValue("password", "wellness.error.required");
			} else {
				if (!PLACEHOLDER.equals(command.getPassword()) || !PLACEHOLDER.equals(command.getConfirmPassword())) {
					...
					if (StringUtils.isEmpty(command.getConfirmPassword())) {
						errors.rejectValue("confirmPassword", "wellness.error.required");
					} else if (!command.getPassword().equals(command.getConfirmPassword())) {
						errors.rejectValue("confirmPassword", "wellness.error.confirmPassword.match");
					}
				}
			}
			...
			if (original != null
				...
				errors.rejectValue("secretAnswer", "wellness.error.secretAnswerNotChangedWithQuestion");
			}
