...
public class ProfileLoginDetailsFragmentController {
	...
	public class ChangePasswordForm extends ValidatingCommandObject {
		...
		public void validate(Object target, Errors errors) {
			...
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "oldPassword", "wellness.error.required");
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "newPassword", "wellness.error.required");
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "confirmNewPassword", "wellness.error.required");
			...
			if (!errors.hasErrors()) {
				if (form.getNewPassword().equals(form.getConfirmNewPassword())) {
					...
					errors.rejectValue("confirmNewPassword", "wellness.error.confirmPassword.match");
				}
			}
		}
	...
	public class ChangeSecretQuestionForm extends ValidatingCommandObject {
		...
		@Override
		public void validate(Object target, Errors errors) {
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "currentPassword", "wellness.error.required");
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "secretQuestion", "wellness.error.required");
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "newSecretAnswer", "wellness.error.required");
		}
