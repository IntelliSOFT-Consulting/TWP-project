...
public class EditPatientFormPageControllerTest extends BaseModuleWebContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.wellness.page.controller.EditProgramFormPageController#controller(String, org.openmrs.PatientProgram, String, String)
	 */
	@Test
	public void controller() {
		...
		Assert.assertThat(result, is("redirect:wellness/enterForm.page?formUuid=8e4e1abf-7c08-4ba8-b6d8-19a9f1ccb6c9&appId=test.app&patientId=7&returnUrl=test.html"));
		...
		String expected = "redirect:wellness/editForm.page?encounterId=" + encounter.getId() + "&appId=test.app&patientId=7&returnUrl=test.html";
