...
public class EmrOpenmrsUrlOverrideControllerTest {
	...
	public void showOurHomepage() {
		...
		Assert.assertThat(controller.showOurHomePage(), is("forward:/wellness/home.page"));
	}
	...
	public void showLoginHomepage() {
		PowerMockito.when(Context.isAuthenticated()).thenReturn(false);
		Assert.assertThat(controller.showOurLoginPage(), is("forward:/wellness/login.page"));
	...
	public void showOurForgotPasswordPage() {
		PowerMockito.when(Context.isAuthenticated()).thenReturn(false);
		Assert.assertThat(controller.showOurForgotPasswordPage(), is("forward:/wellness/forgotPassword.page"));
