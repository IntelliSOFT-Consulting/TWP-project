...
import org.openmrs.module.wellness.form.element.LabTestPickerSubmissionElement;
...
public class LabTestPickerTagHandler extends SubstitutionTagHandler {
	...
	protected String getSubstitution(FormEntrySession session, FormSubmissionController submissionController, Map<String, String> parameters) throws BadFormDesignException {
		LabTestPickerSubmissionElement element = new LabTestPickerSubmissionElement(session.getContext(), parameters);
