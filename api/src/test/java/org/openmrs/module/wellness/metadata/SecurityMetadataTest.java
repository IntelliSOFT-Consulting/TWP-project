...
public class SecurityMetadataTest extends BaseModuleContextSensitiveTest {
	...
	public void install_shouldInstallAllMetadata() {
		...
		Assert.assertThat(registration.hasPrivilege("App: wellness.registration"), is(true));
		Assert.assertThat(registration.hasPrivilege("App: wellness.directory"), is(true));
		Assert.assertThat(registration.hasPrivilege("App: wellness.facilities"), is(true));
		Assert.assertThat(registration.hasPrivilege("App: wellness.admin"), is(false));
	}
