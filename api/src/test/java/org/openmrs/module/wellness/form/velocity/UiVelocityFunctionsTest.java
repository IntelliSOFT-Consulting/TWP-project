...
package org.openmrs.module.wellness.form.velocity;
...
public class UiVelocityFunctionsTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.wellness.form.velocity.UiVelocityFunctions#resourceLink(String, String)
	 */
	@Test
	public void resourceLink() {
		WebConstants.CONTEXT_PATH = "testing";

		Assert.assertThat(functions.resourceLink("wellness", "test.png"), is("/testing/ms/uiframework/resource/wellness/test.png"));
	}
}