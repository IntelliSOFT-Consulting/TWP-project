...
public class KenyaEmrServiceImplTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.wellness.api.impl.KenyaEmrServiceImpl#getDefaultLocation()
	...
	/**
	 * @see org.openmrs.module.wellness.api.impl.KenyaEmrServiceImpl#getDefaultLocationMflCode()
	...
	/**
	 * @see org.openmrs.module.wellness.api.impl.KenyaEmrServiceImpl#getLocationByMflCode(String)
	...
	/**
	 * @see org.openmrs.module.wellness.api.impl.KenyaEmrServiceImpl#getVisitsByPatientAndDay(org.openmrs.Patient, java.util.Date)
	 */
	@Test
